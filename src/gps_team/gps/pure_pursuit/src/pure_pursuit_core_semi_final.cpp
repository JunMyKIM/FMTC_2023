...
int tunnel_end_idx_1 = 1000;
int tunnel_end_idx_2 = 1000;
int tunnel_end_idx_3 = 1000;
int tunnel_end_idx_4 = 1000;
int tunnel_end_idx_5 = 1000;
int tunnel_end_idx_6 = 1000;
int tunnel_end_idx_7 = 1000;
int tunnel_end_idx_8 = 1000;
int tunnel_end_idx_9 = 1000;
int tunnel_end_idx_10 = 1000;



const float tunnel_end_coord_1[2] = {935576.3939516719, 1915708.686304749};//3772
const float tunnel_end_coord_2[2] = {935562.2750400576, 1915704.4455197805};//3831
const float tunnel_end_coord_3[2] = {935545.3499001377, 1915704.4200796913};//3891
const float tunnel_end_coord_4[2] = {935528.7764313526, 1915709.761792568};//3951
const float tunnel_end_coord_5[2] = {935516.1655337156, 1915718.2350908127};//4011
const float tunnel_end_coord_6[2] = {935506.0418133661, 1915729.4629740478};//4071
const float tunnel_end_coord_7[2] = {935499.1616027027, 1915743.7502749383};//4131
const float tunnel_end_coord_8[2] = {935495.0545863969, 1915765.6937909117};//4191
const float tunnel_end_coord_9[2] = {935501.6891436641, 1915786.412051506};//4251
const float tunnel_end_coord_10[2] = {935508.6979547314, 1915801.5801086829};//4311
...
void PurePursuitNode::run(char** argv) {
  ...
  while (ros::ok()) {
    ...
    if (!index_flag) {
      ...
      tunnel_end_idx_1 = pp_.getPosIndex(tunnel_end_coord_1[0], tunnel_end_coord_1[1]);
      tunnel_end_idx_2 = pp_.getPosIndex(tunnel_end_coord_2[0], tunnel_end_coord_2[1]);
      tunnel_end_idx_3 = pp_.getPosIndex(tunnel_end_coord_3[0], tunnel_end_coord_3[1]);
      tunnel_end_idx_4 = pp_.getPosIndex(tunnel_end_coord_4[0], tunnel_end_coord_4[1]);
      tunnel_end_idx_5 = pp_.getPosIndex(tunnel_end_coord_5[0], tunnel_end_coord_5[1]);
      tunnel_end_idx_6 = pp_.getPosIndex(tunnel_end_coord_6[0], tunnel_end_coord_6[1]);
      tunnel_end_idx_7 = pp_.getPosIndex(tunnel_end_coord_7[0], tunnel_end_coord_7[1]);
      tunnel_end_idx_8 = pp_.getPosIndex(tunnel_end_coord_8[0], tunnel_end_coord_8[1]);
      tunnel_end_idx_9 = pp_.getPosIndex(tunnel_end_coord_9[0], tunnel_end_coord_9[1]);
      tunnel_end_idx_10 = pp_.getPosIndex(tunnel_end_coord_10[0], tunnel_end_coord_10[1]);
...
/////////////////////////////////////////////////
    ...
    if(pp_.mode == 7){
      ...
      if(pp_.tunnel_mission_flag == 2){
        ...
        if(drive_mode ==2 && (pp_.reachMissionIdx(tunnel_end_idx_1)||pp_.reachMissionIdx(tunnel_end_idx_2)||pp_.reachMissionIdx(tunnel_end_idx_3)||pp_.reachMissionIdx(tunnel_end_idx_4)||pp_.reachMissionIdx(tunnel_end_idx_5)||pp_.reachMissionIdx(tunnel_end_idx_6)||pp_.reachMissionIdx(tunnel_end_idx_7)||pp_.reachMissionIdx(tunnel_end_idx_8)||pp_.reachMissionIdx(tunnel_end_idx_9)||pp_.reachMissionIdx(tunnel_end_idx_10))){ 
...
void PurePursuitNode::callbackFromEncoder(const std_msgs::Float64& msg) {
  ...
  //////////////방지턱 시작////////////
  if(pp_.mode == 8 && pp_.jaw_mission_flag == 0){
      // std::cout<<"모두 7 진입"<<std::endl;
      ...
      if(pp_.jaw_mission_flag == 0){
        ...
        if(encoder_speed > 12.0){
          ...
          drive_msg.brake = 0.6;
          drive_msg_pub.publish(drive_msg);
          std::cout<<"방지턱 진입 감속 제어 중,,,,"<<std::endl;          
          std::cout<<"encoder speed = "<<encoder_speed<<std::endl;   
